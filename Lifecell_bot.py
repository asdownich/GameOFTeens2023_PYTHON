...
async def start(message: types.Message):
    ...
    await message.answer(f"Привіт, {user_tag}! Я телеграм бот від Lifеcell тут ви можете обрати тариф, створити свій власний або звернутися до  підтримки 😉", parse_mode='HTML', reply_markup=keyboard)
