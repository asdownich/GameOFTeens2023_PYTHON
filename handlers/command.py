...
async def start(message: types.Message):
    ...
    await message.answer(f"Привіт, {user_tag}! Я телеграм бот від Lifеcell тут ви можете обрати, підібрати або створити свій власний тариф чи звернутися до підтримки 😉",
        parse_mode='HTML',
