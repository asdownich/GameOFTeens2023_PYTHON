...
BOT_TOKEN = Bot("6056717794:AAE8KjnkQXAQkDrXScqfUVX6Vmi4q1hP9mo") # створюємо бота
...
async def text(message: types.Message):
    ...
    if msg == 'Обрати Тариф':
        ...
        await message.answer('Якщо вам потрібна додаткова допомога, перейдіть за посиланням нижче:', reply_markup=keyboard) # створюємо клавіатуру
